...
<fieldset class="layui-elem-field">
    ...
    <div class="layui-field-box">
        <form id="saveTeacherForm" action="addTechoperator" method="post" enctype="multipart/form-data" class="layui-form">
            <div class="layui-form-item">
                <label class="layui-form-label layui-form-label-w"><font color="red">*</font>讲师名称</label>
                <div class="layui-input-block">
                    <input name="techName" type="text" class="layui-input layui-input-6" lay-verify="required">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block layui-textarea-block">
                    <textarea class="layui-textarea" id="career" lay-verify="required" name="career"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label layui-form-label-w"><font color="red">*</font>联系方式</label>
                <div class="layui-input-block layui-textarea-block">
                    <input name="phone" type="text" class="layui-input layui-input-6" maxlength="11" lay-verify="required">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label layui-form-label-w">讲师头像</label>
                <div class="layui-input-block">
                    <img src="images/default_head.jpg" id="subjcetpic" width="200px" height="200px">
